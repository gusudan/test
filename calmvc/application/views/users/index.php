        ...
        <div class="panel-body newback">
            <form class="form-horizontal" action="<?php echo URL; ?>users/adduser" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="inputnume" placeholder="Nume" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="inputprenume" placeholder="Prenume" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" class="form-control" name="inputpass" placeholder="Parola" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" class="form-control" name="inputpass2" placeholder="Confirma parola" required>
                    </div>
